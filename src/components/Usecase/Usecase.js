        ...
        <div className="card-box">
          <div className="card">
            ...
            <p className="card-para">
              Entering Vmeet's creative spaces will take your brainstorming
              sessions and workshops to new heights. Our various room
              arrangements will inspire your participants' inventiveness. Vmeet
              lets you to engage with tools and work as if you were in a
              real-life workshop, only better! Magic pointer, 3D pen, 3D models,
              upgraded whiteboards, and much more!
            </p>
          </div>
